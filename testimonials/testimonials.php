    ...
    if (empty($reviews)) {
        $reviews = [
            [
                "name"   => "Yesie Melton", "meta"   => "4 reviews · 4 photos", "when"   => "1 year ago", "rating" => 5, "text"   => "The work (two trees removed) was done promptly and professionally. I highly recommend Vasquez for their communication, attention to detail, and safety. We will definitely have them do additional work in our yard.", "owner"  => ""
            ],
            [
                "name"   => "Becky G.", "meta"   => "7 reviews", "when"   => "6 months ago", "rating" => 5, "text"   => "Vasquez Tree Service provided excellent service. They cleaned up and edged my landscape beds and put down mulch. My yard looks amazing! Highly recommend.", "owner"  => "Ms. Becky we really appreciate your business. Thank you for your wonderful review. God bless."
            ],
            [
                "name"   => "Tony Nalley", "meta"   => "Local Guide · 34 reviews · 3 photos", "when"   => "1 year ago", "rating" => 5, "text"   => "I recently hired Vasquez Tree Service for tree removal and tree trimming at my property, and I am pleased with the results. Their team was professional, knowledgeable, and efficient throughout the entire process. They carefully removed the tree and cleaned up the area thoroughly.", "owner"  => ""
            ],
            [
                "name"   => "Jalen Rose", "meta"   => "8 reviews", "when"   => "2 years ago", "rating" => 5, "text"   => "Vasquez Tree Service and Landscaping is the best in the business! It was the best experience that I’ve ever had with any contractor and I will definitely hire them again.", "owner"  => "Thank you Jalen, always a pleasure to work for you & everyone else."
            ],
            [
                "name"   => "Lisa McMican Ryle", "meta"   => "1 review · 1 photo", "when"   => "2 years ago", "rating" => 5, "text"   => "Absolutely love the company! Great work and fair pricing. Reliable! Forever customer.", "owner"  => ""
            ],
            [
                "name"   => "Carrie White", "meta"   => "11 reviews", "when"   => "1 year ago", "rating" => 5, "text"   => "Have had this team out for the past couple of years. Highly recommend. Very professional, excellent work, friendly crew and reasonable prices.", "owner"  => ""
            ],
            [
                "name"   => "RICHAP RICHAP", "meta"   => "Local Guide · 119 reviews · 4 photos", "when"   => "2 years ago", "rating" => 5, "text"   => "Vasquez gave a very reasonable estimate to clear out some invasive honeysuckle, and responded timely. They were professional and arrived precisely at the time they were scheduled to begin. I would use them again.", "owner"  => "Thanks for your review RICHAP."
            ],
            [
                "name"   => "ramzi78", "meta"   => "1 review", "when"   => "1 year ago", "rating" => 5, "text"   => "Jose is reasonably priced and does a thorough job. He is also knowledgeable and respectful. Would hire again.", "owner"  => ""
            ],
            [
                "name"   => "Papi Perez", "meta"   => "Local Guide · 19 reviews · 1 photo", "when"   => "5 months ago (edited)", "rating" => 5, "text"   => "Great business, gave me a great quote. Showed up as agreed and took care of business. Will recommend to anyone.", "owner"  => ""
            ],
            [
                "name"   => "David Deckard", "meta"   => "2 reviews", "when"   => "2 years ago", "rating" => 5, "text"   => "Wonderful job! On time, reasonable rates, and great attention to detail. Would recommend and hire again.", "owner"  => ""
            ],
            [
                "name"   => "ProgramCoder", "meta"   => "4 reviews", "when"   => "2 years ago", "rating" => 5, "text"   => "Good job. Professional service.", "owner"  => ""
            ],
            [
                "name"   => "Mark Harriman", "meta"   => "", "when"   => "2 years ago", "rating" => 5, "text"   => "Reviews from the web.", "owner"  => ""
            ]
        ];
    }
